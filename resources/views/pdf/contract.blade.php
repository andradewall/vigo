...
<body>
    ...
    <p>
        ...
        4ª) O local de uso do(s) equipamento(s) objeto deste contrato pelo locatário será: Rua Pereira Soares, 14  - casa - Tijuca - Rio de Janeiro, sendo vedada expressamente à transferência de local sob pena de retomada, pela Locadora, do(s) equipamento(s) independente de comunicação prévia;<br />
